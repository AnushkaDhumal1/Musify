        ...
        <div className="min-h-screen bg-gradient-to-br from-green-900 via-black to-green-900 flex items-center justify-center p-4">
            <div className="max-w-md w-full space-y-8">
                ...
                <p className="text-gray-300">
                    Create your accout to start listning
                </p>
                {/*Register form*/}
                <div className="bg-gray-900/80 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-gray-700">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label htmlFor="confirmPassword" className='block text-sm text-gray-200 mb-2'>Confirm Password</label>
                            <input
                                type="password"
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-400">
                            ...
                            <button className="text-green-400 hover hover:text-green-300 font-medium transition-colors cursor-pointer" onClick={onSwitchToLogin}>Sign in hear</button>
                        </p>
                    </div>
